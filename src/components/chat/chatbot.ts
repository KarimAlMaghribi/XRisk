...
export class Chatbot {
    ...
    constructor(risk: Risk | undefined, messages: ChatMessage[]) {
        this.basePrompt = "\"\"\"\n" +
            ...
            "            Der Risikonehmer wird im Schadensfall eine festgelegte Summe an Risikogeber auszahlen.\n" +
            ...
            "            \\s\n" +
            "            Ein Konsens ist erreicht, wenn Klarheit besteht im Hinblick auf:\n" +
            "                Art des Risikos\n" +
            "                Höhe der abgesicherten Summe\n" +
            "                Kosten/Gebühr für die Risikoübername\n" +
            "                Zeitraum\n" +
            ...
            "            Sprich Risikogeber und Risikonehmer mit ihren Namen an, niemals mit Risikogeber oder Risikonehmer.\n" +
            "                              \n" +
            "            \\s\n" +
            "            \"\"\n"
